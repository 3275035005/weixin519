<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="content" label="最新内容" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="回复" prop="reply">
          <el-input v-model="content" placeholder="回复" clearable></el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: { // 创建具体的方法, 定义的方法
    ...
    getList(page = 1) {
      ...
      this.dataVo.counselorId = getToken();
    ...
    onSubmit() {
      ...
      sendReply(this.formData)
        .then(response => { // 请求成功
          ...
          this.content = "";
          this.updateAndSave(this.formData)
        })
    },
